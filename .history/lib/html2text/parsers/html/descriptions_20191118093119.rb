...
module Html2Text
  module Parsers
    class Html
      # Provides the description meta back from the base supplied doc
      class Descriptions < Base
        include Html2Text::Parsers::Concerns::BaseAccessors

        # Returns the best (first) description of the page
        #
        # @return [String] the first/best description meta
        def call
          description
        end
