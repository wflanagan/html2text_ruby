  ...
  module Parsers
    module Concerns
      ...
      module NodeUtils
        ...
        #
        # Supports a second lamba-based argument to
        # perform post processing on the returned
        # node for a search. See the Titles or Description
        # parser for examples of how this works.
        #
