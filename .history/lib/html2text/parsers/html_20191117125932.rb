  ...
  module Parsers
    ...
    class Html
      ...
      def iterate_over(node)
        ...
        binding.pry if node.name.downcase == 'pre'
        return "\n#{Html2Text::Utils::DO_NOT_TOUCH_WHITESPACE}#{node.children.to_html}#{Html2Text::Utils::DO_NOT_TOUCH_WHITESPACE}" if node.name.downcase == 'pre'
