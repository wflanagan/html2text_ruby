  ...
  module Parsers
    ...
    class Html
      ...
      def iterate_over(node)
        ...
        return "\n#{Html2Text::Utils::DO_NOT_TOUCH_WHITESPACE}#{node.text}#{Html2Text::Utils::DO_NOT_TOUCH_WHITESPACE}" if node.name.downcase == 'pre'
      ...
      def doc
        @doc ||= Nokogiri::HTML::DocumentFragment.parse(formatted_html, nil, 'UTF-8')
      end
    end
  end
end
